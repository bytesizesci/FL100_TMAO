...
```{r save PSOtmao4G}
save(PSOtmao4G, file = "../../data/processed/microbiome/phyloseq_objects/PSOtmao4G_211111.RData")
```
...
plot.composition.relAbun <- microbiome::plot_composition(ps3F.10.family.comp,
...
```{r ANCOM - genus level with covariates}
source("../../Rscripts/ancom_v2.1.R")
