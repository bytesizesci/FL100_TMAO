...
Reviewer 1 didn't understand that the relationship between TMAO and age differed by sex. We will make it more clear by stating the restults of the statistical test. 
...
# too messy, point of interaction not obvious
ggplot(phen, aes(x = age, y = tmao_log, group = sex, color = sex)) +
  geom_line() +
  geom_point() +
  geom_errorbar(aes(ymin=tmao_log - sd, ymax=tmao_log+sd),
                width = .2,
...
# try a simplified version - this is better
