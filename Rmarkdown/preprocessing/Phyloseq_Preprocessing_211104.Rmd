...
for(i in seq_along(input_data)){
  ...
  out[[i]] <- ifelse(input_data[,i] <= mdn[i], "below", "above") # assign below if value is less than or equal to median
}
res <- do.call("cbind",out)
colnames(res) <- paste0(colnames(input_data), "_mdn")
rownames(res) <- rownames(input_data)

# Turn to a data frame and rename. Then turn variables into factors as they should be.
str(res[,1:15])
...
write.csv(md2, "../../data/processed/microbiome/phyloseq_inputs/lnBiocrates_mdn_sampledata_211108.csv")
saveRDS(md2, "../../data/processed/microbiome/phyloseq_inputs/lnBiocrates_mdn_sampledata_211108.rds")
```
...
# Metadata
metadata_a <- readRDS("../../data/processed/microbiome/phyloseq_inputs/lnBiocrates_mdn_sampledata_211108.rds")
# Count table
...
save(PSOlogBioc, file = "../../data/processed/microbiome/phyloseq_objects/PSOlogBioc_211108.RData")
```
